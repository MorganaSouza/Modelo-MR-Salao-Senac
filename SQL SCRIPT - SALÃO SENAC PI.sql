...
CREATE TABLE IF NOT EXISTS `mydb`.`CentroDeCusto` (
  `idCentro de Custo` INT NOT NULL,
  `nome` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idCentro de Custo`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Atendimento` (
  ...
  `CentroDeCusto_idCentro de Custo` INT NOT NULL,
  ...
  INDEX `fk_Atendimento_CentroDeCusto1_idx` (`CentroDeCusto_idCentro de Custo` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Atendimento_CentroDeCusto1`
    FOREIGN KEY (`CentroDeCusto_idCentro de Custo`)
    REFERENCES `mydb`.`CentroDeCusto` (`idCentro de Custo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`RelatorioFinanceiro` (
  ...
  INDEX `fk_RelatorioFinanceiro_CentroDeCusto1_idx` (`CentroDeCusto_idCentro de Custo` ASC) VISIBLE,
